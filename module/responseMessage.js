module.exports = {//서버들끼리의 원활한 소통을 위해서 응답메세지를 통일
    ...
    BLOG_READ_ALL_SUCCESS: "블로그 모두 불러오기 성공",
    BLOG_READ_ALL_FAIL: "블로그 모두 불러오기 실패",
    BLOG_PASSWORD_FAIL: "블로그 비밀번호 불일치",
    BLOG_PASSWORD_SUCCESS: "블로그 비밀번호 일치",
    BLOG_UPDATE_FAIL: "블로그 수정 실패",    
    BLOG_UPDATE_SUCCESS: "블로그 수정 성공",
    BLOG_DELETE_FAIL: "블로그 삭제 실패",
    BLOG_DELETE_SUCCESS: "블로그 삭제 성공",
    BLOG_GET_FAIL: "블로그 불러오기 실패",
    BLOG_GET_SUCCESS: "블로그 불러오기 성공",
